			...
			<div className="hidden lg:flex lg:w-5/12 bg-blue-600 flex-col justify-between p-12 relative overflow-hidden">
				...
				<div className="relative">
					...
					<p className="mt-4 text-blue-100 text-sm leading-relaxed max-w-xs">
						Organize your day, track your progress and get more done — simply
						and beautifully.
					</p>
					...
					<div className="mt-10 grid grid-cols-2 gap-4">
						{[
							...
							<div
								key={s.label}
								className="bg-white/10 rounded-2xl px-4 py-4 backdrop-blur-sm"
							>
				...
				<div className="relative bg-white/10 rounded-2xl px-5 py-4 backdrop-blur-sm">
					<p className="text-sm text-blue-50 italic leading-relaxed">
						"I finally feel in control of my workday. TodoApp keeps everything
						in one place."
					</p>
					<div className="mt-3 flex items-center gap-3">
						...
						<div>
							...
							<p className="text-xs text-blue-200">Product Designer</p>
						</div>
					</div>
				</div>
			</div>
